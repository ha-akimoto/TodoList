...
public class TodoAdapter extends RecyclerView.Adapter<TodoAdapter.ViewHolder> {
    ...
    public TodoAdapter(List<TodoRow> list, OnRecyclerListener listener) {
        this.todoList = list;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        // データ表示
        if (this.todoList != null && this.todoList.size() > position && this.todoList.get(position) != null) {
            holder.textView.setText(this.todoList.get(position).getTitle());
        }
